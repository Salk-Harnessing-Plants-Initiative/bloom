...
def test_provenance_checks_all_pass_on_valid_v4_entry():
...
def test_provenance_checks_flags_v2_schema():
    ...
    checks = smoke.provenance_checks(**kwargs)
    assert any(c.name == "manifest schema == 4" and not c.ok for c in checks)
...
def test_qc_persist_checks_all_pass_on_valid_v4_entry():
...
def test_qc_persist_checks_flags_v2_schema():
    ...
    assert any(c.name == "qc_clean: manifest schema == 4" and not c.ok for c in checks)
...
def test_ro_persist_checks_all_pass_on_valid_v4_entry():
...
def test_clustering_persist_checks_all_pass_on_valid_v4_entry():
...
def test_stats_persist_checks_all_pass_on_valid_v4_entry():
