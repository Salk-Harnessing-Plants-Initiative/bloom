...
merged 2026-07-29). **Tier 3's LLM-facing-text slice is in review** (PR
...
- **Adjacent, not-to-duplicate work (cross-referenced, not folded in):**
  ...
  - [bloom#476](https://github.com/Salk-Harnessing-Plants-Initiative/bloom/issues/476)
    ...
    2026-07-29), #476's local-disk-fallback target is genuinely moot to implement against
...
- **Tier 1:** [#546](https://github.com/Salk-Harnessing-Plants-Initiative/bloom/issues/546) — still open as of 2026-07-31 despite PR #548 (which implements it) having merged 2026-07-29; no closing keyword was used in the PR, so it needs closing by hand.
- **Tier 2:** [#551](https://github.com/Salk-Harnessing-Plants-Initiative/bloom/issues/551) — same situation: still open despite PR #557 having merged 2026-07-29.
...
- **Tier 2 shipped, and the follow-up flagged in the 2026-07-23 entry above was resolved
  ...
  merged 2026-07-29 and confirms the anticipated simplification: `SupabaseReader.load_experiment`
