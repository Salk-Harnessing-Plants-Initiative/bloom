-- add timepoints and experiment_id to cyl_datasets

ALTER TABLE cyl_datasets ADD COLUMN experiment_id BIGINT REFERENCES cyl_experiments(id);
ALTER TABLE cyl_datasets ADD COLUMN timepoints JSONB;
...
BEGIN
    -- Create the set
    INSERT INTO cyl_datasets (name, experiment_id, timepoints) VALUES (name, _experiment_id, _timepoints) RETURNING id INTO cyl_dataset_id;
