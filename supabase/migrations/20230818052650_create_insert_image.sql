...
CREATE OR REPLACE FUNCTION insert_image(species_common_name TEXT, experiment TEXT, wave_number INT, germ_day INT, germ_day_color TEXT, plant_age_days INT, date_scanned_ TIMESTAMPTZ, device_name TEXT, plant_qr_code TEXT, accession_name TEXT, frame_number_ INT) RETURNS BIGINT AS $$
DECLARE
