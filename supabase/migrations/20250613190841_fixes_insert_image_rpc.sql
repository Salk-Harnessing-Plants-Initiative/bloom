-- Restoring Initial Funntion

DROP FUNCTION insert_image;

CREATE OR REPLACE FUNCTION insert_image(species_common_name TEXT, experiment TEXT, wave_number INT, germ_day INT, germ_day_color TEXT, plant_age_days INT, date_scanned_ DATE, device_name TEXT, plant_qr_code TEXT, accession_name TEXT, frame_number_ INT) RETURNS BIGINT AS $$
DECLARE
...
BEGIN
    ...
    -- Upsert the scan
    INSERT INTO cyl_scans (plant_id, scanner_id, date_scanned, plant_age_days) VALUES (plant_id_var, scanner_id_var, date_scanned_, plant_age_days)
