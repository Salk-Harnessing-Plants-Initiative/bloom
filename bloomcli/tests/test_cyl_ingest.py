...
# The exact RAISE EXCEPTION substrings from the RPC migration (the live definition is
# supabase/migrations/20260925120000_cyl_writeback_contract_a9.sql), with the
...
RPC_ERRORS = [
    ...
    "contract_version mismatch: got 0.0.0, pinned 0.1.0a9 (single leading v ignored)",
