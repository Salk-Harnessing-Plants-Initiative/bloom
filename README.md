...
- **[Development Setup](./DEV_SETUP.md)** - For local development ([HTML version](https://htmlpreview.github.io/?https://github.com/Salk-Harnessing-Plants-Initiative/bloom/blob/setup-guide/DEV_SETUP.html))
- **[Production Setup](./PROD_SETUP.md)** - For production deployment ([HTML version](https://htmlpreview.github.io/?https://github.com/Salk-Harnessing-Plants-Initiative/bloom/blob/setup-guide/PROD_SETUP.html))
...
├── flask/                  # FastAPI app for video generation
...
- **API**: FastAPI (autogenerated OpenAPI docs at /docs) - http://localhost:5002
...
- **Storage**: MinIO S3
- **API**: FastAPI (production service; OpenAPI docs at /docs)
...
### 1. Development Setup
    ...
    see [DEV_SETUP.md](./DEV_SETUP.md) | [HTML version](https://htmlpreview.github.io/?https://github.com/Salk-Harnessing-Plants-Initiative/bloom/blob/setup-guide/DEV_SETUP.html)

### 2. Production Setup

    see [PROD_SETUP.md](./PROD_SETUP.md) | [HTML version](https://htmlpreview.github.io/?https://github.com/Salk-Harnessing-Plants-Initiative/bloom/blob/setup-guide/PROD_SETUP.html)
