...
import { isNotFound } from "./storage-errors";

// Both video modules gate on this answer, and only "absent" lets a caller act as
// though nothing is stored. Read wrong in that direction, the cyl path overwrites
// a complete rotation and the gravi path offers to re-render a finished video.
