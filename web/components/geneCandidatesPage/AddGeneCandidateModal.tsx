    ...
    const { data: candidateData, error: candidateError } = await supabase
      ...
      if (scientistId !== null && geneCandidate !== null) {
        const { error: linkError } = await supabase
          .from("gene_candidate_scientists")
          .insert({
          ...
          <Box sx={{ maxHeight: 820, overflowY: 'auto', pr: 2 }}>
            ...
            >
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Select Gene" />
                )}
              />
              ...
              {!isFormValid && (
                <Typography variant="body2" color="error" sx={{ mt: 1, alignItems: 'center', display: 'flex', justifyContent: 'center' }}>
