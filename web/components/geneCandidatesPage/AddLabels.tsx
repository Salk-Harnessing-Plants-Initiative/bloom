...
export default function AddLabels({ anchorEl, handleCloseTagPopover, setSelectedTags, selectedTags}: { anchorEl: null | HTMLElement, handleCloseTagPopover: () => void , setSelectedTags : React.Dispatch<React.SetStateAction<GeneTypes.Tag[]>>, selectedTags: GeneTypes.Tag[]}) {
        ...
        <>
            ...
            >
                <Box sx={{ p: 2 }}>
                        ...
                        {availableTags.map((tag) => (
                            ...
                            >
                                ...
                                onChange={(e) => {
                                    ...
                                    checked ? [...prev, tag] : prev.filter((t: GeneTypes.Tag) => t.label !== tag.label)
                                    );
                                }}
                                />
                                <Box
                    ...
                    <strong>Need a new label category?</strong> Request it via email:<br />
