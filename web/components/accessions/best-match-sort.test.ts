...
const rows: BestMatchRow[] = [
  { accession_id: 3, accession_name: "Col-0", uid: "3:g3", gene_id: "g_beta", similarity: 0.91 },
  { accession_id: 1, accession_name: "Abd-0", uid: "1:g1", gene_id: "g_alpha", similarity: 0.97 },
  { accession_id: 2, accession_name: "Zu-0", uid: "2:g2", gene_id: "g_gamma", similarity: 0.88 },
];
...
describe("sortBestMatchRows", () => {
  ...
  it("treats a null name/gene as an empty string (sorts first ascending)", () => {
    const withNull: BestMatchRow[] = [
      { accession_id: 5, accession_name: "Bur-0", uid: "5:g5", gene_id: "z", similarity: 0.5 },
      { accession_id: 6, accession_name: null, uid: "6:g6", gene_id: "a", similarity: 0.4 },
    ];
