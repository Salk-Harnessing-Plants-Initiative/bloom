  ...
  return (
    <div>
      ...
      <p className="mb-8 max-w-2xl text-sm text-stone-500">
        Trait values from cylinder phenotyping experiments, grouped by species.
        Pick a species to browse its experiments and per-plant trait timelines.
      </p>
