...
- [x] 2.4 Confirmed via CI (`Docker Compose Health Check`, run 33524629806 and again on the
      ...
      `test_execute_grants_are_exactly_the_sanctioned_roles`. The a7 body has been live on staging
      since bloom#787 closed (2026-09-08). Evidence carried from PR #779, which this archive
      supersedes (archived by `repin-cyl-contract-a9`, 2026-09-25)
...
- [x] 2.6 (post-review, `/review-pr`) Fixed a real CI-caught bug in
      ...
      migration applications and fall back to the ambient committed body — which, post-merge, is
      itself the a7-pinned body). And fixed two stale `0.1.0a3` literals in
